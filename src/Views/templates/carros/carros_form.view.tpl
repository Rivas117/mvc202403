...
<section class="grid">
    <form action="index.php?page=Carros-CarrosForm&mode={{mode}}&codigo={{codigo}}" method="post" class="row">
        ...
        <div class="row col-6 offset-3">
            ...
            <input class="col-8" type="number" name="anio" id="anio" value="{{anio}}" {{~readonly}} />
        </div>
        <div class="row col-6 offset-3">
            <label class="col-4" for="kilometraje">Kilometraje</label>
            <input class="col-8" type="number" name="kilometraje" id="kilometraje" value="{{kilometraje}}"
                {{~readonly}} />
        </div>
        <div class="row col-6 offset-3">
        ...
        <div class="row col-6 offset-3">
            ...
            <input class="col-8" type="number" name="cilindraje" id="cilindraje" value="{{cilindraje}}" {{~readonly}} />
        </div>
        <div class="row col-6 offset-3">
        ...
        <div class="row col-6 offset-3">
            <label class="col-4" for="precioventa">Precio Venta</label>
            <input class="col-8" type="number" name="precioventa" id="precioventa" value="{{precioventa}}"
                {{~readonly}} />
        </div>
        <div class="row col-6 offset-3">
            <label class="col-4" for="preciominio">Precio Minimo</label>
            <input class="col-8" type="number" name="preciominio" id="preciominio" value="{{preciominio}}"
                {{~readonly}} />
        </div>
        <div class="row col-6 offset-3">
            <label class="col-4" for="notas">Notas</label>
