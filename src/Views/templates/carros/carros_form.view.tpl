...
<section>
    <form action="index.php?page=Carros-CarrosForm&mode={{mode}}&codigo={{codigo}}" method="post">
        ...
        <div>
            ...
            <input type="number" name="anio" id="anio" value="{{anio}}">
        </div>
        <div>
            <label for="kilometraje">Kilometraje</label>
            <input type="number" name="kilometraje" id="kilometraje" value="{{kilometraje}}">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" name="cilindraje" id="cilindraje" value="{{cilindraje}}">
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" name="precioventa" id="precioventa" value="{{precioventa}}">
        </div>
        <div>
            <label for="preciominio">Precio Minimo</label>
            <input type="number" name="preciominio" id="preciominio" value="{{preciominio}}">
        </div>
        <div>
